...
#class InceptionV3(nn.Module):
    ...
    #         If true, uses the pretrained Inception network used in Tensorflow's
    #         FID implementation. If false, uses the pretrained Inception network
    #         available in torchvision. The FID Inception network has different
    #         weights and a slightly different structure from torchvision's
    #         Inception network. If you want to compute FID scores, you are
